...
const functions = __importStar(require("../metadata/functions.json"));
...
for (let func of functions.default) {
    ...
    forgescript_1.Logger.info(`${func.category}: ${func.name}`);
}
(0, fs_1.writeFileSync)("metadata/functions.json", JSON.stringify(newFunctions));
